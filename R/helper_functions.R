...
GetModels_HPCA <- function(){
  return(readRDS(url("https://github.com/Sanofi-Public/PMCB-SignacX/tree/main/assets/Models_HPCA.rds?raw=TRUE","rb")))
}
...
GetTrainingData_HPCA <- function(){
  return(readRDS(url("https://github.com/Sanofi-Public/PMCB-SignacX/tree/main/assets/training_HPCA.rds?raw=TRUE","rb")))
}
